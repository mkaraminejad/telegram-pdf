...
const PRESET_SAMPLES = [
  {
    title: 'نمونه ۱: متن وارونه و حروف بریده (خروجی افتضاح OCR سنتی)',
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/20 text-indigo-300 text-xs font-semibold border border-indigo-400/30">
              ...
              موتور هوش مصنوعی پس‌زمینه (Gemini Multimodal Vision + Celery)
            </div>
            <h2 className="text-xl font-bold tracking-tight text-white sm:text-2xl">
              حل ریشه‌ای مشکل خروجی‌های افتضاح و وارونه در اسناد PDF فارسی
            </h2>
            <p className="text-xs text-slate-300 leading-relaxed max-w-3xl">
              ابزارهای سنتی OCR به دلیل کدگذاری‌های بصری غیراستاندارد در فونت‌های فارسی، حروف را جداافتاده و کلمات را وارونه بازخوانی می‌کنند. در معماری جدید، هوش مصنوعی در پس‌زمینه فریم‌های سند را به صورت دیداری تحلیل کرده و ساختار کامل متن، جداول و عناوین را با زبان فارسی دقیق و راست‌به‌چپ واقعی بازتولید می‌نماید.
            </p>
          </div>
